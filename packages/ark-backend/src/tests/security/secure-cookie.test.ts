...
describe('Cookie security', () => {
  test('cookie.sameSite should be lax by default', (done) => {
          ...
          .then((res) => {
            ...
            supertest(app)
              ...
              .then((res) => {
                ...
                /** Check if sameSite is lax by default */
  ...
  test('cookie.sameSite should be strict when modified', (done) => {
    const appContext = new ApplicationContext();
    appContext
      .activate(({ use }) => {
        const { useService } = use(Backend);
  ...
  test('cookie.httpOnly should be true default', (done) => {
    const appContext = new ApplicationContext();
    appContext
      .activate(({ use }) => {
        const { useService } = use(Backend);
          ...
          .then((res) => {
            ...
            supertest(app)
              ...
              .then((res) => {
                ...
                /** Check if HttpOnly; is set by default */
